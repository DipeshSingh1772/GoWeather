...
const Card = ({data}) => {
    ...
    return (
        ...
        <div className="card">
          ...
          <div className="main">{temperatureConverter(data.main.temp)} °C</div>
          <div className="mainsub">{data.name}, India</div>
        </div>
        <div className="card2">
          <div className="upper">
            <div className="humidity">
              <div className="humiditytext">Humidity<br />{data.main.humidity}%</div>
          ...
          KHRFWHRkYXRlOnRpbWVzdGFtcAAyMDIzLTAyLTE2VDE4OjE5OjAwKzAwOjAwSbgwlgAAAABJRU5ErkJggg==" y={0} x={0} height={30} width={30} id="image0" />
            ...
            <div className="air">
              <div className="airtext">Wind<br />{data.wind.speed} Km/h</div>
          ...
          OFQwNToxNToyNiswMDowMIjQlfwAAAAASUVORK5CYII=" />
              ...
              <div className="realfeeltext">Real Feel<br />{temperatureConverter(data.main.feels_like)} °C</div>
            </div>
          ...
          Ut8AAAAASUVORK5CYII=" />
              ...
              <div className="pressuretext">Pressure<br />{data.main.pressure} mbar</div>
            </div>
            <div className="card3">
              Healthy
            </div>
